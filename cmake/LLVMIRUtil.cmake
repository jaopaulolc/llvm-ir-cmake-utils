...
function(llvmir_attach_bc_target)
  ...
  foreach(IN_FILE ${IN_FILES})
    ...
    file(MAKE_DIRECTORY "${WORK_DIR}/${OUT_DIR_NAME}")
    set(OUT_LLVMIR_FILE "${OUT_DIR_NAME}/${OUTFILE}.${LLVMIR_BINARY_FMT_SUFFIX}")
...
function(llvmir_attach_disassemble_target)
  ...
  foreach(IN_LLVMIR_FILE ${IN_LLVMIR_FILES})
    get_filename_component(OUTFILE ${IN_LLVMIR_FILE} NAME)
    set(INFILE "${IN_LLVMIR_DIR}/${IN_LLVMIR_FILE}")
